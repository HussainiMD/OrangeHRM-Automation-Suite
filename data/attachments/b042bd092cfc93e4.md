...
- Name: ui/regression/admin/update-employee-validation.spec.ts >> TC_ADM_USER_STATUS_007 | Admin | User Management | Disabled user cannot access modules via direct URL
- Location: tests/ui/regression/admin/update-employee-validation.spec.ts:275:1
