...
- Name: ui/regression/admin/update-employee-validation.spec.ts >> TC_ADM_USER_STATUS_001 | Admin | User Management | Search user by username returns correct record
- Location: tests/ui/regression/admin/update-employee-validation.spec.ts:53:1
