...
- Name: ui/regression/admin/update-employee-validation.spec.ts >> TC_ADM_USER_STATUS_004 | Admin | User Management | Re-enable disabled user
- Location: tests/ui/regression/admin/update-employee-validation.spec.ts:96:1
