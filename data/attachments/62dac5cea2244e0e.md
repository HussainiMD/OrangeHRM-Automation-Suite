...
- Name: ui/regression/admin/update-employee-validation.spec.ts >> TC_ADM_USER_STATUS_006 | Admin | User Management | Disable user terminates active session
- Location: tests/ui/regression/admin/update-employee-validation.spec.ts:208:1
