...
```
Error: A snapshot doesn't exist at /home/runner/work/OrangeHRM-Automation-Suite/OrangeHRM-Automation-Suite/tests/ui/regression/auth/login-ui.spec.ts-snapshots/ohrm-branding-staging-chrome-linux.png, writing actual.
```
