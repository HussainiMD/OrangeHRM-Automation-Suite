...
- Name: ui/smoke/auth/disabledUserAuthentication.smoke.spec.ts >> TC_LOGIN_010 | Authentication | Disabled Account | Disabled users are prevented from logging in
- Location: tests/ui/smoke/auth/disabledUserAuthentication.smoke.spec.ts:11:1
