...
export function isCredentialsEnvValid() : boolean {
    const fields : Array<any> = [process.env.base_url, process.env.admin_user_name, process.env.admin_password, process.env.ess_user_name, process.env.ess_user_password];
